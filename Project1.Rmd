...
#Observations for 
Tag.Dep.sd <- sd(Tag.compare[2,1], 25000)
Tag.In.sd <- sd(Tag.compare[2,2], 25000)
Tag.Out.sd <- sd(Tag.compare[2,3],25000)

#Prep matrix for bar plot
Tag.compare <- t(Tag.compare)

#Create bar plot
barplot(Tag.compare, width=1, names.arg=c("Deep", "Inlet", "Outlet"),beside=TRUE, horiz=FALSE, col=c("Yellow","Blue"),main="Verrucomicrobia Proportion", xlab="Sample", ylab="Relative Proportion", xlim=c(0,17),ylim=c(0,0.55), axisnames=TRUE)
...
#### Discussion
The standard deviation of the CARD-FISH proportion is extremely high. To decrease this and increase the power and accuracy of my data, I should conduct more counts.
