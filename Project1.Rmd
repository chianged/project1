...
FISH.Out.sd <- sd(Abs.Rel[2,3], 1000)
...
barplot(Tag.compare, width=1, names.arg=c("Deep", "Inlet", "Outlet"), legend.text=c("CARD-FISH", "Sequencing"), beside=TRUE, horiz=FALSE, main="Verrucomicrobia Proportion", xlab="Sample", ylab="Relative Proportion", axisnames=TRUE)
```
