...
I first calculate the total counts.
```{r, echo=FALSE}
...
From the total counts, I can use the size of the area I counted to determine the number of cells/mL.
```{r, echo=FALSE}
...
Next, I calculate the proportion of bacteria and *Verrucomicrobia* cells to DAPI cells.
```{r, echo=FALSE}
