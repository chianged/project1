...
#Add legend
legend(x=c(10,17), y=c(0,0.1), legend=c("CARD-FISH","Molecular"), col=c("yellow","blue"), pch=15)
...
For future CARD-FISH, I would like to examine specific classes of *Verrucomicrobia*.

Most importantly, I need to finish learning how to analyze the OTU data exported from Mothur so I can calculate proportions myself instead of relying on help from Marian and Vincent. My senior thesis will depend upon statistical analysis with R; in other words, I need to step up my game.
